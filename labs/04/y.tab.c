...
{
      -1,    -5,    -9,    -2,    16,    20,    -1,     6,    12,    -9,
      -9,    -9,    -9,    12,    12,    12,    12,    -9,     6,    10,
      10,    -9,    -9
};
...
{
       0,    13,    12,     0,     0,     0,     2,     7,     0,     5,
       6,     1,     3,     0,     0,     0,     0,    13,     4,     8,
       9,    10,    11
};
...
{
      18,     9,     1,     2,     8,    19,    20,    21,    22,     3,
       4,    13,    14,    15,    16,    17,     2,    15,    16,    10,
      11,    12
};

static const yytype_uint8 yycheck[] =
{
       8,     3,     3,     4,     9,    13,    14,    15,    16,    10,
      11,     5,     6,     7,     8,     3,     4,     7,     8,     3,
       0,     6
};
...
{
       0,     3,     4,    10,    11,    13,    14,    15,     9,     3,
       3,     0,    13,     5,     6,     7,     8,     3,    15,    15,
      15,    15,    15
};
...
#line 20 "calc.y" /* yacc.c:1646  */
    { if(valid[(yyvsp[0])] == 0) yyerror("syntax error"); else printf("%d\n", reg[(yyvsp[0])]);}
...
#line 28 "calc.y" /* yacc.c:1646  */
    { if((yyvsp[0]) == 0) yyerror("syntax error"); else (yyval) = (yyvsp[-2]) / (yyvsp[0]);}
